...
LeePositionControllerNode::LeePositionControllerNode(
  ...
  cmd_pose_sub_ = nh_.subscribe("command/pose", 1,
      &LeePositionControllerNode::CommandPoseCallback, this);

  cmd_multi_dof_joint_trajectory_sub_ = nh_.subscribe("command/trajectory", 1,
  ...
  command_timer_ = nh_.createTimer(ros::Duration(0), 
      &LeePositionControllerNode::TimedCommandCallback, this, true, false);
}
